...
export const mockFood: CategoryItem[] = [
  { id: 'f1', name: 'Mum Aroi', description: 'Seafood restaurant with ocean views', rating: 4.6, reviewCount: 1240, location: 'Naklua', distance: '2.1 km', isOpen: true, tags: ['Seafood', 'Thai'], priceRange: '$$' },
  { id: 'f2', name: 'Glass House', description: 'Beachfront dining with live music', rating: 4.4, reviewCount: 890, location: 'Na Jomtien', distance: '8.5 km', isOpen: true, tags: ['International', 'Seafood'], priceRange: '$$$' },
...
export const mockHotels: CategoryItem[] = [
  { id: 'h1', name: 'Hilton Pattaya', description: 'Luxury hotel in Central Festival complex', rating: 4.6, reviewCount: 3200, location: 'Central Pattaya', distance: '0.5 km', isOpen: true, tags: ['5-Star', 'Pool'], priceRange: '$$$$' },
...
export const mockBeaches: CategoryItem[] = [
  ...
  { id: 'b3', name: 'Koh Larn', description: 'Island paradise with crystal clear water', rating: 4.5, reviewCount: 6200, location: 'Offshore', distance: '7.5 km', isOpen: true, tags: ['Island', 'Snorkeling'] },
...
export const mockAttractions: CategoryItem[] = [
  { id: 'a1', name: 'Sanctuary of Truth', description: 'Magnificent wooden temple by the sea', rating: 4.7, reviewCount: 4500, location: 'Naklua', distance: '4.2 km', isOpen: true, tags: ['Temple', 'Culture'], priceRange: '$$' },
...
export const mockNightlife: CategoryItem[] = [
  { id: 'n1', name: 'Walking Street', description: 'Famous entertainment strip with bars and clubs', rating: 4.3, reviewCount: 8200, location: 'South Pattaya', distance: '1.2 km', isOpen: true, tags: ['Bars', 'Clubs'] },
...
export const mockShopping: CategoryItem[] = [
  { id: 's1', name: 'Terminal 21 Pattaya', description: 'Airport-themed mega mall', rating: 4.6, reviewCount: 5800, location: 'North Pattaya', distance: '2.5 km', isOpen: true, tags: ['Mall', 'Food Court'], priceRange: '$$' },
...
export const mockActivities: CategoryItem[] = [
  { id: 'ac1', name: 'Ramayana Water Park', description: 'Thailand\'s largest water park', rating: 4.6, reviewCount: 4200, location: 'Na Jomtien', distance: '12 km', isOpen: true, tags: ['Water Park', 'Family'], priceRange: '$$' },
